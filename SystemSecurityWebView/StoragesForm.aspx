<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoragesForm.aspx.cs" Inherits="PlumbingRepairWebView.FormStorages" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="PlumbingRepairService.ImplementationsList.StorageServiceList"></asp:ObjectDataSource>
