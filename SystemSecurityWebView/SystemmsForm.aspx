<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemmsForm.aspx.cs" Inherits="PlumbingRepairWebView.FormServices" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="PlumbingRepairService.ImplementationsList.ServiceServiceList"></asp:ObjectDataSource>
