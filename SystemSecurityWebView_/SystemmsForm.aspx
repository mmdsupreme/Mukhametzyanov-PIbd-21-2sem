<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemmsForm.aspx.cs" Inherits="SystemSecurityWebView.FormServices" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="SystemSecurityService.BDImplementation.SystemmBD"></asp:ObjectDataSource>
