<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoragesForm.aspx.cs" Inherits="SystemSecurityWebView.FormStorages" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="SystemSecurityService.BDImplementation.StorageBD"></asp:ObjectDataSource>
