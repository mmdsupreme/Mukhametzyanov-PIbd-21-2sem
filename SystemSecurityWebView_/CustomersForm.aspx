<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomersForm.aspx.cs" Inherits="SystemSecurityWebView.FormCustomers" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="SystemSecurityService.BDImplementation.CustomerBD"></asp:ObjectDataSource>
