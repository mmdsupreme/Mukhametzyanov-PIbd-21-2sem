<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ElementsForm.aspx.cs" Inherits="SystemSecurityWebView.FormElements" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="SystemSecurityService.BDImplementation.ElementBD"></asp:ObjectDataSource>
